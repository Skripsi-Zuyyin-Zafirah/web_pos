    ...
    <div className="min-h-screen bg-muted/20 pb-20">
      ...
      <div className="bg-slate-900 text-white py-16 px-6 relative overflow-hidden shadow-2xl">
        ...
        <div className="max-w-4xl mx-auto space-y-6 relative z-10">
          <Badge className="bg-blue-500 hover:bg-blue-600 border-none px-4 py-1 text-sm">Antrean Prioritas Real-time</Badge>
          <h1 className="text-4xl font-black tracking-tight sm:text-6xl">Lacak Pesanan Anda</h1>
          <p className="text-slate-400 text-lg max-w-xl">
            Sistem Min-Heap cerdas kami memastikan pesanan tercepat diproses terlebih dahulu untuk meminimalkan waktu tunggu keseluruhan.
          </p>
                ...
                <div className="md:w-48 flex flex-col justify-center items-center p-6 bg-white/10 rounded-2xl backdrop-blur-md">
                  <Progress value={((orders.length - myOrderIndex) / orders.length) * 100} className="h-3 bg-white/20 mb-3" />
                    <p className="text-xs font-bold text-center opacity-80">
                      Prioritas: Durasi {orders[myOrderIndex].ewp / 60}m
                    </p>
                </div>
              </div>
            </CardContent>
